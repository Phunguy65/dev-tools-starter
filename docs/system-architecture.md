...
## Overview
Dev Tools Starter is a Trunk plugin that distributes shared linter/formatter configurations to consuming projects. Architecture follows a plugin-based distribution model.
...
- Specify runtime requirements (Node, Python, Go, Ruby)
...
### 2. Language Runtimes
- **Node.js 22.16.0**: Biome, markdownlint-cli2
- **Python 3.10.8**: Ruff, Pyright
- **Rust toolchain**: Clippy, rustfmt
- **Go 1.24.3**: Additional tooling
- **Ruby 3.4.2**: Additional tooling
